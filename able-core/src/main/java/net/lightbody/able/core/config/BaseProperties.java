...
public class BaseProperties extends Properties {
     ...
     * Get float value.
     */
    public float getFloat(final String str) throws Exception {
        String value = getProperty(str);
        if (value == null) {
            throw new Exception(str + " not found");
        }
        ...
        try {
            ...
            throw new Exception("BaseProperties.getFloat()", ex);
        }
    }

    public float getFloat(final String str, final float floatVal) {
        try {
            return getFloat(str);
        } catch (Exception ex) {
            return floatVal;
